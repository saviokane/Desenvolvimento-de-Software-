...
//	    System.out.println(Mensagem.ATUALIZAR_CLIENTE);
	    ...
	    for (int i = 0; i < registro.getPessoa().size(); i++) {
	        ...
	        System.out.println((i + "\nID: ["+1)+"] " + pessoa.getNome() + " - " + pessoa.getCpf());
	    }
	...
	public static void selecionar() {
		Scanner leitor = new Scanner (System.in);
		    ...
		    for (Pessoa registro1 : registro.getPessoa()) {
		        ...
		        System.out.println("\n[" + i+"]" +Mensagem.MSG_NOME + registro1.getNome() +
		                            Mensagem.MSG_CPF  + registro1.getCpf() +
		                            Mensagem.MSG_TELEFONE + registro1.getTelefone()+
		                            Mensagem.MSG_TELEFONE + registro1.getEmail());
		    }
		    ...
		    if (i > 0 && i <= registro.getPessoa().size()) {
		     ...
		     System.out.println(Mensagem.CLIENTE_SELECIONADO + cliente);
